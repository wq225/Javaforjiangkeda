...
public class ProductServiceImplTests {
    ...
    public void save(){
        ...
        productInfo.setProductId("7788");
        productInfo.setProductName("橙子炖蛋");
        productInfo.setProductPrice(new BigDecimal(300));
        productInfo.setProductStock(99);
        productInfo.setProductDescription("香香");
        productInfo.setProductIcon("httplllll.jpg");
    ...
    @Test
    public void onSale(){
        ProductInfo sale=productService.onSale("4399");
        Assert.assertEquals(ProductStatusEnum.UP.getCode(),sale.getProductStatus());
    }

    @Test
    public void offSale(){
        ProductInfo sale=productService.offSale("222");
